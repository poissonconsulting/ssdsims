...
- **Dependencies**: only if the chosen format requires one (e.g. a base64 helper); the binary-`serialize` option needs no new dependency. Recorded with the decision in `design.md`.
