...
designs that combine scenarios, cloud upload, cost estimation/analysis, and
reproducible RNG) with links to the corresponding pkgdown articles.
...
- **THEN** the README SHALL point to the relevant articles
  (`defining-a-scenario`, `sharded-pipeline`, `scenario-to-design`,
