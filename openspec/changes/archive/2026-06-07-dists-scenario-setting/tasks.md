...
- [x] 1.1 In `R/scenario.R`, move the `dists` formal out of the fit-axis block of `ssd_define_scenario()` to lead the scenario-settings block: `… parametric, dists, proportion, ci, samples, partition_by, bundle`
...
- [x] 3.2 Re-record any scenario `print()` snapshots affected by the fit/hc option grouping
