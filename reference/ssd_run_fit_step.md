...
#> [1] "/tmp/RtmpW0LHzP/file393a590e64d4/sample/dataset=ccme_boron/sim=1/replace=FALSE/part.parquet"
ssd_run_fit_step(
...
#> [1] "/tmp/RtmpW0LHzP/file393a590e64d4/fit/dataset=ccme_boron/sim=1/nrow=6/rescale=FALSE/part.parquet"
# }
```
