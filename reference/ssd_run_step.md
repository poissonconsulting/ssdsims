...
#> [1] "/tmp/RtmpKjUHx1/file3b3f7d9788b9/sample/dataset=ccme_boron/sim=1/replace=TRUE/part.parquet"
# \donttest{
data <- ssd_scenario_data(ssddata::ccme_boron)
...
#> [1] "/tmp/RtmpKjUHx1/file3b3f78139898/sample/dataset=ccme_boron/sim=1/replace=TRUE/part.parquet"
ssd_run_fit_step(
...
#> [1] "/tmp/RtmpKjUHx1/file3b3f78139898/fit/dataset=ccme_boron/sim=1/nrow=6/rescale=FALSE/part.parquet"
# }
# \donttest{
data <- ssd_scenario_data(ssddata::ccme_boron)
scenario <- ssd_define_scenario(
...
#> [1] "/tmp/RtmpKjUHx1/file3b3f7f616967/sample/dataset=ccme_boron/sim=1/replace=TRUE/part.parquet"
ssd_run_fit_step(
  ssd_scenario_fit_shards(scenario)$tasks[[1L]],
  scenario,
  file.path(dir, "sample"),
...
#> [1] "/tmp/RtmpKjUHx1/file3b3f7f616967/fit/dataset=ccme_boron/sim=1/nrow=6/rescale=FALSE/part.parquet"
ssd_run_hc_step(
...
#> [1] "/tmp/RtmpKjUHx1/file3b3f7f616967/hc/dataset=ccme_boron/sim=1/part.parquet"
# }
```
