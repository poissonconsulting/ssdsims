...
#> [1] "/tmp/RtmpHSShDe/file36913ba02bd/sample/dataset=ccme_boron/sim=1/replace=FALSE/part.parquet"
ssd_run_fit_step(
...
#> [1] "/tmp/RtmpHSShDe/file36913ba02bd/fit/dataset=ccme_boron/sim=1/nrow=6/rescale=FALSE/part.parquet"
ssd_run_hc_step(
...
#> [1] "/tmp/RtmpHSShDe/file36913ba02bd/hc/dataset=ccme_boron/sim=1/part.parquet"
# }
```
