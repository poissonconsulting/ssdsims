...
test_that("sdd_get_streams_seeds streams and skip", {
  ...
  expect_snapshot(withr::with_seed(10, sdd_get_streams_seeds(nseeds = 1L, nstreams = 2L, skip = 1L))) 
  expect_identical(withr::with_seed(10, sdd_get_streams_seeds(nseeds = 2L, nstreams = 2L))[[2]][2],
                   withr::with_seed(10, sdd_get_streams_seeds(nseeds = 1L, nstreams = 2L, skip = 1L))[[2]])
})
