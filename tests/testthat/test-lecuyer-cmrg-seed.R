test_that("get_lecuyer_cmrg_states_stream no seeds", {
  expect_identical(
...
test_that("get_lecuyer_cmrg_states_stream repeatable", {
...
test_that("get_lecuyer_cmrg_states_stream seed fast enough", {
  expect_snapshot(withr::with_seed(
    10,
    get_lecuyer_cmrg_states_stream(
      seed = NULL,
...
test_that("get_lecuyer_cmrg_states_stream stream fast enough", {
  expect_snapshot(withr::with_seed(
    10,
    get_lecuyer_cmrg_states_stream(
      seed = NULL,
...
test_that("get_lecuyer_cmrg_states_stream seed stream fast enough", {
  expect_snapshot(withr::with_seed(
    10,
    get_lecuyer_cmrg_states_stream(
      seed = NULL,
...
test_that("get_lecuyer_cmrg_states_stream seeds stream fast enough", {
...
test_that("get_lecuyer_cmrg_states_stream repeatable multiple seeds", {
  expect_snapshot(withr::with_seed(
    10,
    get_lecuyer_cmrg_states_stream(
      seed = NULL,
...
test_that("get_lecuyer_cmrg_states_stream differs multiple seeds", {
...
test_that("get_lecuyer_cmrg_states_stream repeatable other starts", {
  expect_snapshot(withr::with_seed(
    42,
    get_lecuyer_cmrg_states_stream(
      seed = NULL,
...
test_that("get_lecuyer_cmrg_states_stream differs other starts seeds", {
  expect_false(identical(
    withr::with_seed(
      10,
      get_lecuyer_cmrg_states_stream(
...
test_that("get_lecuyer_cmrg_states_stream seeds repeatable with other seed types", {
...
test_that("get_lecuyer_cmrg_states_stream seeds differ with other seed types", {
  expect_false(identical(
    withr::with_seed(
      10,
      get_lecuyer_cmrg_states_stream(
...
test_that("get_lecuyer_cmrg_states_stream passses seed", {
  expect_identical(
    withr::with_seed(
      37,
      get_lecuyer_cmrg_states_stream(10, nsim = 1L, stream = 1L, start_sim = 1L)
    ),
    withr::with_seed(
      42,
      get_lecuyer_cmrg_states_stream(10, nsim = 1L, stream = 1L, start_sim = 1L)
...
test_that("get_lecuyer_cmrg_states_stream does not advance seed", {
  withr::with_seed(10, {
...
test_that("get_lecuyer_cmrg_states_stream local withr work", {
  local_lecuyer_cmrg_seed(10)
  seed <- get_lecuyer_cmrg_states_stream(
    seed = NULL,
    nsim = 1L,
    stream = 1L,
    start_sim = 1L
...
test_that("get_lecuyer_cmrg_states_stream return values state different sub-streams", {
...
test_that("get_lecuyer_cmrg_states_stream return values state different sub-streams (snapshot)", {
  states <- withr::with_seed(
    10,
    get_lecuyer_cmrg_states_stream(
      seed = NULL,
...
test_that("get_lecuyer_cmrg_state_stream return values state different streams", {
  s1 <- withr::with_seed(
    10,
    get_lecuyer_cmrg_state_stream(seed = NULL, stream = 1L, start_sim = 1L)
  )
  s2 <- withr::with_seed(
    10,
    get_lecuyer_cmrg_state_stream(seed = NULL, stream = 2L, start_sim = 1L)
  )
  expect_false(identical(
