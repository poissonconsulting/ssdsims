...
environment (`SSDSIMS_AZURE_STORAGE_ACCOUNT` plus one of `SSDSIMS_AZURE_STORAGE_KEY`,
`SSDSIMS_AZURE_STORAGE_SAS`, or the service-principal trio) at call time, and the object
...
#| eval: false
Sys.setenv(SSDSIMS_AZURE_STORAGE_ACCOUNT = "<account>", SSDSIMS_AZURE_STORAGE_KEY = "<key>")
