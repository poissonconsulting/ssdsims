...
#> [1] "upload_sample_ccme_boron_1_FALSE" "upload_sample_ccme_boron_2_FALSE"
...
#> "/tmp/RtmpXzBxVd/ssdsims-shards-3b7839c08f4e/hc/dataset=ccme_boron/sim=1/part.parquet".
#> [1] TRUE
```
