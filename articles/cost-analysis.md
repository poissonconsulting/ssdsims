...
#>   total compute:  17.1 s
#>   longest task:   3.9 s
#>   breakdown (ci_method x nboot, by total cost):
#>     weighted_samples       nboot   1000     4 tasks  14.7 s
...
#>   total compute:  predicted 22.4 s | observed 17.1 s | obs/pred 0.76x
#>   longest task:   predicted 6.7 s | observed 3.9 s | obs/pred 0.59x
```
