...
#>   total compute:  15.7 s
#>   longest task:   3.6 s
#>   breakdown (ci_method x nboot, by total cost):
#>     weighted_samples       nboot   1000     4 tasks  13.6 s
...
#>   total compute:  predicted 22.4 s | observed 15.7 s | obs/pred 0.70x
#>   longest task:   predicted 6.7 s | observed 3.6 s | obs/pred 0.53x
```
...
#>   total compute:  15.4 s
#>   longest task:   2.0 s
#>   breakdown (ci_method x nboot, by total cost):
#>     weighted_samples   nboot   1000     4 tasks  7.9 s
#>     weighted_samples   nboot    100     4 tasks  7.5 s
#>   calibration:    AMD EPYC 7763 64-Core Processor | R 4.6.0 | ssdtools 2.6.0.9002 | 2026-06-20
