...
# itself (it is a Suggested dependency). Load it here so every targets worker
# that sources this file can activate the dqrng backend; without it a shard
# aborts with a reminder.
library(dqrng)
